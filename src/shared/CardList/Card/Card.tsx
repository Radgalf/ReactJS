...
import {IGenericListProps} from "../../GenericList";
...
const MENU_ITEMS: IGenericListProps = {
  list: [{
    text: (<>
...
export function Card(props: ICardProps) {
  return (
    <li className={styles.card} >
      ...
      />
      <Menu button={<button> Show</button>}>
        <ul className={styles.menuItemsList}>
          <MenuItem title="Комментарий" icon={()}/>
          <div className={styles.divider}/>
          <MenuItem title="Поделиться" icon={(<svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className={styles.divider}/>
          <MenuItem title="Скрыть" icon={(<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className={styles.divider}/>
          <MenuItem title="Сохранить" icon={(<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className={styles.divider}/>
          <MenuItem title="Пожаловаться" icon={(<svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">

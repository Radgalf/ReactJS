...
const MENU_ITEMS: IItem[] = [
  {
    itemContent: <MenuItem title="Комментарий" icon={<svg width="15" height="15" viewBox="0 0 15 15" fill="none"
  ...
  {
    itemContent: <MenuItem title="Поделиться" icon={<svg width="12" height="14" viewBox="0 0 12 14" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
      <path
  ...
  {
    itemContent: <MenuItem title="Скрыть" icon={<svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
      <path
  ...
  {
    itemContent: <MenuItem title="Сохранить" icon={<svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
      <path
  ...
  {
    itemContent: <MenuItem title="Пожаловаться" icon={
